  ...
  return (
    <div>
      <div className="flex items-start justify-between gap-4 mb-5">
        <div>
          <h2 className="text-base font-semibold mb-0.5" style={{ color: "#1A1A2E", fontFamily: "var(--font-open-sans)" }}>
            Opening hours
          </h2>
      ...
      >
        ...
        />
        <div>
          <p className="text-sm font-semibold" style={{ color: "#1A1A2E" }}>Available 24 hours, 7 days a week</p>
      ...
      {!hours.availability24hr && (
        <div className="mb-6">
          <p className="text-xs font-semibold uppercase tracking-wider mb-3" style={{ color: "#5C5C7A" }}>
            Office hours
          </p>
              ...
              return (
                <div key={key} className="flex items-center gap-3 flex-wrap">
                  <label className="flex items-center gap-2 cursor-pointer" style={{ minWidth: "110px" }}>
                    ...
                    />
                    <span className="text-sm" style={{ color: "#5C5C7A" }}>{label}</span>
                  </label>
                  {d.open ? (
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="text-sm rounded-lg px-2 py-1 focus:outline-none focus-visible:ring-1 focus-visible:ring-[#6B6DE8]"
                        style={{ background: "#FAFAFA", border: "1px solid #E8E8F4", color: "#5C5C7A", minHeight: "36px" }}
                      />
      ...
      {/* OOH section */}
      <div className="pt-5" style={{ borderTop: "1px solid #E8E8F4" }}>
        <p className="text-xs font-semibold uppercase tracking-wider mb-3" style={{ color: "#5C5C7A" }}>
          Out-of-hours contact
        </p>
        <div className="space-y-3">
          <div>
            <label className="block text-sm font-medium mb-1.5" style={{ color: "#1A1A2E" }}>Phone number</label>
            <input
              type="tel"
              ...
              style={{ background: "#FAFAFA", border: "1px solid #E8E8F4", color: "#5C5C7A", minHeight: "44px" }}
            />
          </div>
          <div>
            <label className="block text-sm font-medium mb-1.5" style={{ color: "#1A1A2E" }}>Typical response time</label>
            <select
