        ...
        {[1, 2, 3, 4, 5].map((s) => (
          ...
          >
            <Star
              ...
              style={{
                color: s <= active ? "#E26B5E" : "rgba(197,210,220,0.8)",
                fill: s <= active ? "#E26B5E" : "rgba(197,210,220,0.8)",
              }}
            />
          </button>
        ))}
      </div>
      <p className="text-sm mt-1.5 min-h-[20px] transition-all" style={{ color: "#8FA0B0" }} aria-live="polite">
