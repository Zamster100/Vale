...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(user.onboarded ? "/admin/dashboard" : "/admin/onboard");
    } catch {
        ...
        <div className="w-full max-w-md animate-question-enter">
          ...
          <div className="mt-8 pt-6 text-center" style={{ borderTop: "1px solid #D5D0E4" }}>
            <p className="text-sm" style={{ color: "#4A415E" }}>
              ...
              <Link href="/admin/signup" className="font-medium hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-[#4F34C4] rounded" style={{ color: "#100B20" }}>
                Create one
              </Link>
            </p>
          </div>
