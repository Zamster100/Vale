  ...
  return (
    <div style={{ background: "#F7F3EE" }}>
      ...
      <section
        ...
        style={{ background: "#1C1F2A", minHeight: "88vh" }}
      >
        {/* Dot grid */}
        <div
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 55% 60% at 85% 40%, rgba(94,139,115,0.1) 0%, transparent 65%)",
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative max-w-5xl mx-auto px-6 md:px-10 py-28 md:py-36">
          ...
          >
            ...
            Verified providers.
            <br />
            <em style={{ color: "#5E8B73", fontStyle: "italic" }}>Genuine choice.</em>
          </h1>
      ...
      <section
        ...
        style={{ background: "#F7F3EE", borderBottom: "1px solid #E8E2D8" }}
      >
            ...
            {[
              ...
              <div key={label} className="flex items-center gap-1.5">
                <div
                  ...
                  style={{ background: "#1C1F2A", color: "#F7F3EE" }}
                  aria-label={`${label} ${sub}`}
                >
                  {label}
                </div>
                <span className="text-[11px] font-medium" style={{ color: "#7A6E64" }}>
                  {sub}
                </span>
              </div>
            ))}
          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            {["FT", "Guardian", "BBC"].map((pub) => (
              <span
                ...
                style={{ color: "#1C1F2A", opacity: 0.38 }}
              >
                {pub}
              </span>
            ))}
      ...
      <section
        className="py-20 md:py-28 px-6 md:px-10"
        style={{ background: "#EAF2EE", borderBottom: "1px solid #D4E3DA" }}
      >
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center">
          ...
          >
            ...
            <em style={{ color: "#5E8B73", fontStyle: "italic" }}>near you</em>
          </h2>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              <em style={{ color: "#5E8B73" }}>Not to profit from it.</em>
            </h2>
            <p
      ...
      <section
        className="py-20 md:py-28 px-6 md:px-10"
        style={{ background: "#F7F3EE", borderTop: "1px solid #E8E2D8" }}
      >
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-[1fr_2fr] gap-12 md:gap-16 items-start">
            ...
            <div>
              ...
              <p
                ...
                style={{ color: "#7A6E64", maxWidth: "280px" }}
              >
              ...
              {COST_ITEMS.map(({ label, price, desc, tag }) => (
                ...
                >
                  <div>
                    ...
                    <div className="text-xs leading-relaxed" style={{ color: "#7A6E64" }}>
                      {desc}
                    </div>
                  </div>
                  <div
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div>
              ...
              <div
                ...
                style={{ color: "rgba(234,242,238,0.38)" }}
              >
              ...
              {VAULT_FEATURES.map(({ icon: Icon, label, desc }) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: "rgba(234,242,238,0.52)" }}
                  >
                    {desc}
                  </div>
                </div>
      ...
      <section
        className="py-20 md:py-28 px-6 md:px-10"
        style={{ background: "#FFFFFF", borderTop: "1px solid #E8E2D8" }}
      >
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-[2fr_3fr] gap-12 md:gap-16 items-start">
            ...
            <div>
              ...
              >
                Not all reviews are{" "}
                <em style={{ color: "#5E8B73" }}>equal.</em>
              </h2>
              <p
                className="text-sm leading-relaxed mb-8"
                style={{ color: "#7A6E64", maxWidth: "320px" }}
              >
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-sm font-medium" style={{ color: "#1C1F2A" }}>
                        {author}
                      </div>
                      <div className="text-xs" style={{ color: "#7A6E64" }}>
                        {location} · {date}
                      </div>
                    </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            >
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                <Users className="w-12 h-12" style={{ color: "#5E8B73", opacity: 0.3 }} />
                <span className="text-sm" style={{ color: "#5E8B73", opacity: 0.4 }}>
            ...
            <div>
              ...
              >
                A real person.{" "}
                <em style={{ color: "#5E8B73" }}>No pressure. Free.</em>
              </h2>
              <p
                className="text-sm leading-relaxed mb-8"
                style={{ color: "#7A6E64", maxWidth: "360px" }}
              >
      ...
      <section
        className="py-20 md:py-28 px-6 md:px-10"
        style={{ background: "#1C1F2A", borderTop: "1px solid rgba(255,255,255,0.04)" }}
      >
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <em style={{ color: "#C4975A" }}>verified families.</em>
            </h2>
            <p
              className="mb-8 leading-relaxed"
              style={{
      ...
      <section className="relative overflow-hidden" style={{ background: "#1C1F2A" }}>
        ...
        <div className="relative max-w-5xl mx-auto grid md:grid-cols-2">
          ...
          >
            ...
            >
              We&apos;re here with you,{" "}
              <em style={{ color: "#5E8B73" }}>right now.</em>
            </h2>
            <p
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                ...
                style={{
                  ...
                  color: "#5E8B73",
                  border: "1px solid rgba(94,139,115,0.32)",
                }}
              >
          ...
          <div className="px-8 md:px-14 py-24 md:py-32">
            ...
            >
              Give your family{" "}
              <em style={{ color: "#C4975A" }}>certainty.</em>
            </h2>
            <p
              className="mb-10 leading-relaxed max-w-sm"
              style={{ fontSize: "15px", color: "rgba(234,242,238,0.6)" }}
            ...
            <p className="text-xs mt-6" style={{ color: "rgba(234,242,238,0.28)" }}>
