  ...
  return (
    <div className="relative shrink-0">
      <select
        ...
        aria-label={label}
        className="appearance-none pl-3.5 pr-8 py-2 rounded-full text-sm cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6B6DE8] min-h-[36px]"
        style={{
          background: "white",
    ...
    >
      <div className="flex flex-col sm:flex-row">
        ...
        <Link
          ...
          className="relative sm:w-64 lg:w-72 h-52 sm:h-auto shrink-0 block overflow-hidden bg-[#D2D3FC]"
          tabIndex={-1}
          aria-hidden="true"
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 shrink-0">
              <a
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium transition-all min-h-[40px] hover:bg-[#FAFAFA] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6B6DE8]"
          ...
          >
            <div className="relative flex-1 max-w-xl">
              ...
              <input
                ...
                onFocus={(e) => {
                  e.currentTarget.style.border = "1.5px solid #6B6DE8";
                  e.currentTarget.style.boxShadow =
                    "0 0 0 3px rgba(94,139,115,0.12)";
                }}
                onBlur={(e) => {
                  e.currentTarget.style.border = "1px solid #E8E8F4";
          ...
          <div className="flex items-center gap-2 pb-3 overflow-x-auto scrollbar-none">
            ...
            {SERVICE_FILTERS.map(({ value, label }) => (
              <button
                ...
                className="shrink-0 px-3.5 py-1.5 rounded-full text-sm font-medium transition-all min-h-[36px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#6B6DE8]"
                style={
                  serviceFilter === value
            ...
            <p
              ...
              style={{ color: "#5C5C7A" }}
            >
              <span className="font-semibold" style={{ color: "#5C5C7A" }}>
